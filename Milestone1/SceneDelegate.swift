...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    let viewModel = ViewModel(potatos: [Potato(name: "Kipfler", family:"Sweet Potato", weight: "20grams", scienceName: "Solanum tuberosum", nutrition: "manganese, potassium and vitamin C", image: "potato"),
        Potato( name: "Vitelotte", family:"Starch Potato", weight: "300grams", scienceName: "Solanum Vitelotte", nutrition: "protien, potassium and vitamin C", image: "potato1"), Potato(name: "Kipfler", family:"Sweet Potato", weight: "20grams", scienceName: "Solanum tuberosum", nutrition: "manganese, potassium and vitamin C", image: "potato")],listTitle: "Potatos")
